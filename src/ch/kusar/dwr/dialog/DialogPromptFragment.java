...
public class DialogPromptFragment extends DialogFragment implements
...
//	}
	...
	public void onClick(View v) {
		OnDialogDoneListener act = (OnDialogDoneListener) getFragmentManager().findFragmentById(R.id.overview);
	 ...
	 */
	public static DialogPromptFragment newInstance(String prompt) {
		DialogPromptFragment dpf = new DialogPromptFragment();
