...
public class DialogMessageFragment extends DialogFragment implements
	 ...
	 */
	public static DialogMessageFragment newInstance(String prompt) {
		DialogMessageFragment dpf = new DialogMessageFragment();
